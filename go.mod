...
require (
	...
	github.com/induzo/gocom/database/pginit/v2 v2.2.30
	github.com/induzo/gocom/http/health v1.1.24
	github.com/induzo/gocom/shutdown v1.3.4
...
require (
	...
	github.com/induzo/gocom/database/pgx-slog v1.0.34 // indirect
