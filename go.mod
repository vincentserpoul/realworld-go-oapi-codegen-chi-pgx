...
require (
	...
	github.com/induzo/gocom/database/pginit/v2 v2.2.19
	github.com/induzo/gocom/http/health v1.1.15
	github.com/induzo/gocom/shutdown v1.3.2
...
require (
	...
	github.com/induzo/gocom/database/pgx-slog v1.0.22 // indirect
