...
require (
	...
	github.com/induzo/gocom/database/pginit/v2 v2.2.1
	github.com/induzo/gocom/http/health v1.1.1
	github.com/induzo/gocom/shutdown v1.2.1
...
require (
	...
	github.com/induzo/gocom/database/pgx-slog v1.0.4 // indirect
	github.com/induzo/gocom/http/middleware/writablecontext v0.1.2
